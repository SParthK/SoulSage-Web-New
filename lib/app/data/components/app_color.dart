...
class AppColors {
  ...
  static const Color appColor = Color(0xFF344CC2);
  static const Color appIconColor = Color(0xFFA193BF);
  ...
  static const Color appGrey = Color(0xD3FFFFFF);
  static const Color textColor = Color(0xff272833);
}
